...
class LocalUpdate(object):
    ...
    def update_weights(self, model, global_round, idx_user,syn_dataset,images_all,train_dataset,test_dataset):
...
#        model.train()
        ...
        if self.args.optimizer == 'sgd':
            ...
            optimizer = FedProx(model.parameters(), lr=self.args.lr, weight_decay=1e-3, mu=0.01,ratio=0.05
                                        )
        ...
        if self.args.dataset =='cifar10' or self.args.dataset == 'cifar100' or self.args.dataset == 'tiny_imagenet' or self.args.dataset == 'imagenet':

            labels_all = origin_dataset.dataset.targets
        elif self.args.dataset == 'fedcifar100':
            labels_all = origin_dataset.tensors[1]
        ...
        #mae_criterion = MeanAbsoluteError(10,self.device)
...
#            ep+=1
        ...
        return model.state_dict(), sum(epoch_loss) / len(epoch_loss), loss_list, conv_grad, fc_grad, total_norm, dst_syn_train, output_client,indicate_class
